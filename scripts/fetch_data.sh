...
unzip data/PuzzleIOI/fitting.zip -d ./data/PuzzleIOI/fitting 
...
unzip data/PuzzleIOI/puzzle_capture.zip -d ./data/PuzzleIOI/puzzle_capture 

echo -e "\nDownloading PuzzleIOI ground-truth renderings used for evaluation..."
wget --post-data "username=$username&password=$password" https://download.is.tue.mpg.de/download.php?domain=puzzleavatar&sfile=rendering_4views.zip&resume=1 -O $DATA_DIR/rendering_4views.zip --no-check-certificate --continue
unzip data/PuzzleIOI/gt_4views.zip -d ./data/PuzzleIOI/gt_4views 
